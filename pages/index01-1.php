<?php
// 读取数据
$json_data = file_get_contents('../data/data01.json');
...
<head>
    ...
    <title>EJU日语词汇学习 PART1 001-100</title>
...
<body>
    ...
    <nav class="navbar navbar-light bg-light shadow-sm px-4">
        <span class="navbar-brand mb-0 h1"><i class="fas fa-book-open text-primary"></i> EJU日语词汇学习 (PART1 001-100)</span>
        <!-- 新增导航按钮组 -->
                    ...
                    <div class="card h-100 shadow vocab-card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <button class="btn btn-sm btn-primary btn-speak" onclick="speak('<?php echo $item['word']; ?>')">
